...
export interface IOTXRegistrarControllerInterface extends utils.Interface {
  functions: {
...
export interface IOTXRegistrarController extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IOTXRegistrarControllerInterface;
