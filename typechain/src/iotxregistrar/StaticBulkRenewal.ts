...
export interface StaticBulkRenewalInterface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: "renewAll" | "rentPrice" | "supportsInterface"
  ): FunctionFragment;
...
export interface StaticBulkRenewal extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StaticBulkRenewalInterface;
